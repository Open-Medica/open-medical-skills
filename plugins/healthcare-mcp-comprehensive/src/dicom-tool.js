...
export class DicomTool extends BaseTool {
  ...
  extractMetadata(filePath) {
    if (!filePath) return this.formatErrorResponse('File path is required');
    ...
    try {
      ...
      return this.formatSuccessResponse({ patientName, patientId, studyDescription, seriesDescription });
    } catch (error) {
